...
def run_joint_pipeline(
    sample_frac=1.0, target_n=None, balance_taxonomically=True
):
    print("=" * 60)
    ...
    # Generate complete baseline visualization suite
    ...
    generate_hierarchical_hsv_tsne(evaluator, pruning_levels=PRUNING_LEVELS)
    compute_and_plot_top10_rank_taxonomy(
        evaluator, pruning_levels=PRUNING_LEVELS
    )
